    ...
    return(
        <div>
            <nav className="w-full bg-purple-500 shadow" style={{backgroundColor: "#F8F6F4"}}>
                <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
                    <div>
                        ...
                        <p className="mx-auto text-xl font-semibold justify-center items-center">
                                IT SUPPORT
                        </p>
                ...
                <div className="hidden space-x-2 md:inline-block">
                    <a href="/" className="px-4 py-2 rounded-md shadow hover:bg-gray-800" style={{backgroundColor: "#D2E9E9"}}>
                        +User
                    </a>
                    <a href="/qst" className="px-4 py-2 rounded-md shadow hover:bg-gray-100" style={{backgroundColor: "#D2E9E9"}}>
                        +Questionnaire
                    </a>
            ...
            <div className="container my-12 mx-auto px-4 md:px-12">
                <h4>Klik baris data user di bawah tabel ini untuk memberikan review dan edit review yang telah diberikan.</h4>
